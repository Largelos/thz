...
REGISTER_MAP = {
    ...
    "pxxFB": [
        ...
        (" relHumidity: ", 70, 4, "n.a.", 1, {"unit": "%", "device_class": "humidity", "state_class": "measurement", "translation_key": "rel_humidity"}),
        (" dewPoint: ", 5, 4, "n.a.", 1, {**_TEMP, "icon": "mdi:weather-fog", "translation_key": "dew_point"}),
        (" P_Nd: ", 5, 4, "n.a.", 1, {**_PRESSURE, "translation_key": "pressure_nd"}),
        (" P_Hd: ", 5, 4, "n.a.", 1, {**_PRESSURE, "translation_key": "pressure_hd"}),
        (" actualPower_Qc: ", 5, 8, "n.a.", 1, {**_POWER, "translation_key": "actual_power_qc"}),
        (" actualPower_Pel: ", 5, 8, "n.a.", 1, {**_POWER, "translation_key": "actual_power_pel"}),
