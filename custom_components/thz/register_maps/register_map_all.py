...
_SPEED = {"unit": "Hz", "device_class": "frequency", "state_class": "measurement", "icon": "mdi:speedometer"}
_FAN_POWER = {"unit": "%", "state_class": "measurement", "icon": "mdi:fan"}
...
REGISTER_MAP = {
    ...
    "pxxFB": [
        ...
        (
            ...
            "hex2int",
            100,
            {"unit": "l/min", "state_class": "measurement", "icon": "mdi:water-pump", "translation_key": "flow_rate"},
        ),  # board X51 sensor P5 (on newer models B1 flow temp as well) changed to l/min as suggested by TheTrumpeter Antwort #771
        ("p_HCw:", 114, 4, "hex", 100, {**_PRESSURE, "translation_key": "pressure_hc"}),  # board X4-1..3 sensor P4 HC water pressure
        ("humidityAirOut:", 154, 4, "hex", 100, {**_HUMIDITY, "translation_key": "humidity_air_out"}),  # board X4-4..6 sensor B15
    ],
    "pxxF2": [
    ...
    "pxx0A0176": [
        ("switchingProg: ", 11, 1, "bit0", 1, {"icon": "mdi:calendar-clock", "translation_key": "switching_prog"}),
        ("compressor:", 11, 1, "bit1", 1, {"icon": "mdi:engine", "translation_key": "compressor"}),
        ("heatingHC:", 11, 1, "bit2", 1, {"icon": "mdi:radiator", "translation_key": "heating_hc"}),
        ("heatingDHW:", 10, 1, "bit0", 1, {"icon": "mdi:water-boiler", "translation_key": "heating_dhw"}),
        ("boosterHC:", 10, 1, "bit1", 1, {"icon": "mdi:flash", "translation_key": "booster_hc"}),
        ("filterBoth:", 9, 1, "bit0", 1, {"icon": "mdi:air-filter", "translation_key": "filter_both"}),
        ("ventStage:", 9, 1, "bit1", 1, {"icon": "mdi:fan", "translation_key": "vent_stage"}),
        ("pumpHC:", 9, 1, "bit2", 1, {"icon": "mdi:pump", "translation_key": "pump_hc"}),
        ("defrost:", 9, 1, "bit3", 1, {"icon": "mdi:snowflake-melt", "translation_key": "defrost"}),
        ("filterUp:", 8, 1, "bit0", 1, {"icon": "mdi:air-filter", "translation_key": "filter_up"}),
        ("filterDown:", 8, 1, "bit1", 1, {"icon": "mdi:air-filter", "translation_key": "filter_down"}),
